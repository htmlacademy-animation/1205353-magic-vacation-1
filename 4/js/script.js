...
class FullPageScroll {
  ...
  changeVisibilityDisplay() {
    this.screenElements.forEach((screen) => {
      const shouldBeDelayed = screen.hasAttribute(`data-delay`) && this.screenElements[this.activeScreen].hasAttribute(`data-bg`);
      if (shouldBeDelayed) {
        setTimeout(() => {
